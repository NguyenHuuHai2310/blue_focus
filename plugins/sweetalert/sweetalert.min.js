!function(t, e) {
    ...
    function Mt(t, e) {
        ...
        N(l, e, "header"),
            ...
            n = t,
            o = e,
            (r = St.innerParams.get(n)) && o.icon === r.icon && k() ? N(k(), o, "icon") : (Dt(), o.icon && (-1 !== Object.keys(Z).indexOf(o.icon) ? (i = C(".".concat(Y.icon, ".").concat(Z[o.icon])), ot(i), Ut(i, o), Nt(), N(i, o, "icon"), mt(i, o.showClass.icon)) : F('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))),
            function(t) {
                var e = A();
                if (!t.imageUrl)
                    return it(e);
    ...
    function Jt(t) {
        for (var e in t)
            ...
            t.toast && (o = e, -1 !== ne.indexOf(o) && _('The parameter "'.concat(o, '" is incompatible with toasts'))),
            $t(n = e) && g(n, $t(n));
        var n,
            o,
            i
...
function swalConfirm(n="Bạn có chắc chắn muốn thực thi?") {
    return swal.fire({
        title: n,
        text: "",
        icon: "warning",
...
function swalError(n="Thao tác thất bại!") {
    return swal.fire({
        title: n,
        text: "",
        icon: "error"
...
function swalSuccess(n="Thao tác thành công!", t="") {
    return swal.fire({
        title: n,
        html: t,
        icon: "success"
...
function swalLoading(n="Vui lòng chờ") {
    return swal.fire({
        title: n,
        text: "",
        icon: "info",
...
function swalX(n) {
    var t = "Lỗi chưa xác định!";
    try {
        t = t.message ? t.message.toString() : n.responseJSON.message || n.statusText
    } catch (n) {}
    swalError(t)
}
function swalInput(n, t="", e="number") {
...
function swalConfirmX(n="Xác Nhận", t="Bạn có chắc chắn muốn thực thi?") {
    return swal.fire({
        title: n,
        text: t,
        icon: "warning",
